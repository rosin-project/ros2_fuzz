import unittest
import os
from topic2type.main import line2field


class TestTopic2Type(unittest.TestCase):
    @staticmethod
    ...
    def test_positive_tests(self):
        ...
        for field in positive_tests:
            with self.subTest(field=field):
                self.assertIsNotNone(line2field(field))
    ...
    def test_bounded_string(self):
        ...
        self.assertEqual(processed.string_max_size, 15)
        self.assertFalse(processed.is_array)
    ...
    def test_fixed_array_length(self):
        ...
        self.assertEqual(processed.array_size, 5)
        self.assertTrue(processed.is_array)
        self.assertFalse(processed.is_bounded_array_size)
    ...
    def test_bounded_array_length(self):
        ...
        self.assertEqual(processed.array_size, 5)
        self.assertTrue(processed.is_array)
        self.assertTrue(processed.is_bounded_array_size)
